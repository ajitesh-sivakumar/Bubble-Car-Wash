...
<center>
	...
	<div>
		...
		<tr>
			...
			<td><a href="/searchbydate">Delete Entry</a></td>
	...
	<h2>Search by Car Type and Date</h2>
	<form method="POST" action="searchbycartypeanddate">
	...
	<table border="1">
            ...
            <tbody>
                <c:forEach var="list" items="${sbctanddlist}">
                   <tr>
                       <td>${list.getUuid()}</td>
